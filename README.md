...
Hardcode the paramaters instead of taking inputs like:
    ...
    - instruction = " Write a simple HTML code example for students that demonstrates the basic structure of an HTML webpage. The code should include a heading, a paragraph, and a link. Keep it clean, well indented, and beginner-friendly."
    - context = "The students are new to HTML and learning how to structure a webpage. The goal is to provide a clear, easy-to-understand example that introduces fundamental HTML elements"
    - example = "
